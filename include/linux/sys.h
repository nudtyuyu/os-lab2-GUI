...
extern void sys_repaint();
extern int sys_timer_destroy();
...
sys_get_message,sys_post_message,sys_timer_create,sys_exit_graphics,sys_repaint,sys_timer_destroy};
